...
#define INTERNAL_TX_BUFFER_SIZE				(64)
#define INTERNAL_RX_BUFFER_SIZE             (64)
...
//  ***************************************************************************
uint8_t* usart0_get_internal_tx_buffer_address() {
...
/// @return Buffer address
//  ***************************************************************************
const uint8_t* usart0_get_internal_rx_buffer_address() {
